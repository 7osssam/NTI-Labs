...
void LCD_init(void)
{
	...
	DIO_SetPinDirection(LCD_DATA_PORT_ID, LCD_DB4_PIN_ID, PIN_OUTPUT);
	DIO_SetPinDirection(LCD_DATA_PORT_ID, LCD_DB5_PIN_ID, PIN_OUTPUT);
	DIO_SetPinDirection(LCD_DATA_PORT_ID, LCD_DB6_PIN_ID, PIN_OUTPUT);
	DIO_SetPinDirection(LCD_DATA_PORT_ID, LCD_DB7_PIN_ID, PIN_OUTPUT);
...
{
	DIO_SetPinValue(LCD_RS_PORT_ID, LCD_RS_PIN_ID, LOGIC_LOW); /* Instruction Mode RS=0 */
	_delay_ms(1);											   /* delay for processing Tas = 50ns */
	DIO_SetPinValue(LCD_E_PORT_ID, LCD_E_PIN_ID, LOGIC_HIGH);  /* Enable LCD E=1 */
	_delay_ms(1);											   /* delay for processing Tpw - Tdws = 190ns */

#if (LCD_DATA_BITS_MODE == _4_BIT_MODE)
	DIO_SetPinValue(LCD_DATA_PORT_ID, LCD_DB4_PIN_ID, READ_BIT(command, 4));
	DIO_SetPinValue(LCD_DATA_PORT_ID, LCD_DB5_PIN_ID, READ_BIT(command, 5));
	DIO_SetPinValue(LCD_DATA_PORT_ID, LCD_DB6_PIN_ID, READ_BIT(command, 6));
	DIO_SetPinValue(LCD_DATA_PORT_ID, LCD_DB7_PIN_ID, READ_BIT(command, 7));

	_delay_ms(1);											  /* delay for processing Tdsw = 100ns */
	DIO_SetPinValue(LCD_E_PORT_ID, LCD_E_PIN_ID, LOGIC_LOW);  /* Disable LCD E=0 */
	_delay_ms(1);											  /* delay for processing Th = 13ns */
	DIO_SetPinValue(LCD_E_PORT_ID, LCD_E_PIN_ID, LOGIC_HIGH); /* Enable LCD E=1 */
	_delay_ms(1);											  /* delay for processing Tpw - Tdws = 190ns */

	DIO_SetPinValue(LCD_DATA_PORT_ID, LCD_DB4_PIN_ID, READ_BIT(command, 0));
	DIO_SetPinValue(LCD_DATA_PORT_ID, LCD_DB5_PIN_ID, READ_BIT(command, 1));
	DIO_SetPinValue(LCD_DATA_PORT_ID, LCD_DB6_PIN_ID, READ_BIT(command, 2));
	DIO_SetPinValue(LCD_DATA_PORT_ID, LCD_DB7_PIN_ID, READ_BIT(command, 3));
...
{
	DIO_SetPinValue(LCD_RS_PORT_ID, LCD_RS_PIN_ID, LOGIC_HIGH); /* Data Mode RS=1 */
	_delay_ms(1);												/* delay for processing Tas = 50ns */
	DIO_SetPinValue(LCD_E_PORT_ID, LCD_E_PIN_ID, LOGIC_HIGH);	/* Enable LCD E=1 */
	_delay_ms(1);												/* delay for processing Tpw - Tdws = 190ns */

#if (LCD_DATA_BITS_MODE == _4_BIT_MODE)
	DIO_SetPinValue(LCD_DATA_PORT_ID, LCD_DB4_PIN_ID, READ_BIT(data, PIN4_ID));
	DIO_SetPinValue(LCD_DATA_PORT_ID, LCD_DB5_PIN_ID, READ_BIT(data, PIN5_ID));
	DIO_SetPinValue(LCD_DATA_PORT_ID, LCD_DB6_PIN_ID, READ_BIT(data, PIN6_ID));
	DIO_SetPinValue(LCD_DATA_PORT_ID, LCD_DB7_PIN_ID, READ_BIT(data, PIN7_ID));
	...
	DIO_SetPinValue(LCD_DATA_PORT_ID, LCD_DB4_PIN_ID, READ_BIT(data, PIN0_ID));
	DIO_SetPinValue(LCD_DATA_PORT_ID, LCD_DB5_PIN_ID, READ_BIT(data, PIN1_ID));
	DIO_SetPinValue(LCD_DATA_PORT_ID, LCD_DB6_PIN_ID, READ_BIT(data, PIN2_ID));
	DIO_SetPinValue(LCD_DATA_PORT_ID, LCD_DB7_PIN_ID, READ_BIT(data, PIN3_ID));
...
void LCD_displayHex(uint32 num)
{

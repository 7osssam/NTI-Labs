/******************************************************************
 * @Module   	: Timer
 * @Title 	 	: Sourse file for the Timer driver
 * @Filename 	: Timer.h
 * @target  	: ATMEGA32
...
void Timer0_init(const Timer0_ConfigType* Config_Ptr)
{
	...
	//*********************************************** Clock Select ************************************************/
	TCCR0 = (TCCR0 & 0XF8) | (Config_Ptr->Clock_source & 0X07);

	//*********************************************** Compare Output Modes ****************************************/
	switch (Config_Ptr->OC0_Mode)
	{
	...
	//*********************************************** Initial Value ************************************************/
	if (Config_Ptr->Timer0_Mode == TIMER0_FASTPWM_MODE || Config_Ptr->Timer0_Mode == TIMER0_PHASECORRECT_MODE)
	{
		TCNT0 = 0;
...
// void Timer1_init(uint16 compare_value, uint16 initial_value, Timer1Mode_type mode, Clock_type Clock_source, OC1A_Mode_type OC1A_Mode, OC1B_Mode_type OC1B_mode)
void Timer1_init(const Timer1_ConfigType* Config_Ptr)
{
	...
	//*********************************************** Timer 1 Clock_source ******************************************/
	TCCR1B = (TCCR1B & 0xF8) | (Config_Ptr->Clock_source & 0x07);

	//*********************************************** Initial Value ************************************************/
	switch (Config_Ptr->Timer1_Mode)
	{

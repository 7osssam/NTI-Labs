...
#define GPIOA_BASE		  ((volatile)(APB2PERIPH_BASE + GPIOA_OFFSET))
#define GPIOB_BASE		  ((volatile)(APB2PERIPH_BASE + GPIOB_OFFSET))
#define GPIOC_BASE		  ((volatile)(APB2PERIPH_BASE + GPIOC_OFFSET))

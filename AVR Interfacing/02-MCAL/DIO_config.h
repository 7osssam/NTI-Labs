...
#define PD2_PIN_DIRECTION	  PIN_INPUT
#define PD3_PIN_DIRECTION	  PIN_INPUT
#define PD4_PIN_DIRECTION	  PIN_INPUT
#define PD5_PIN_DIRECTION	  PIN_INPUT
#define PD6_PIN_DIRECTION	  PIN_INPUT
...
/* PORTD PINS */
#define PD0_PIN_INITIAL_VALUE LOGIC_LOW
#define PD1_PIN_INITIAL_VALUE LOGIC_LOW
#define PD2_PIN_INITIAL_VALUE LOGIC_LOW
